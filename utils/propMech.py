# Implementation of the proposed mechanism for continuous space (Park et al.)
...
class Local_ProposedMech_Continuous:
    def __init__(self, 
        ...
        ub_norm: int = max(ceil(ub_norm), ceil(1.0 / lb_norm))
        lb_norm = 1/ ub_norm

        print(f"Pure Local c2 is: {ub_norm}")
        print(f"Pure Local c1 is: {lb_norm} \n")
...
class ProposedMech_Continuous:
    def __init__(self, 
        ...
        print(f"Pure glocal c2 is: {ub_norm}")
        print(f"Pure global c1 is: {lb_norm} \n")
